...
const BACKEND_VERSION = '2026.09.22-supuestos-declarados';
...
require('./instrumento').register(app, {
    getSheetsClient,
    SPREADSHEET_ID,
    normalizeEmailKey,
    normalizeGroupKey,
...
console.log('[BACKEND] Instrumento de seguimiento registrado (/api/admin/instrumento-digitalizacion).');
